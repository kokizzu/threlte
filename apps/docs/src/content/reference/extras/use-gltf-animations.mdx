...
When you want to reuse parts of the GLTF such as materials, nodes, or the embedded camera, load it with [`useGltf`](/docs/reference/extras/use-gltf) and pass the auto-subscribed value through the getter.
